...
export default function LoginLoading() {
    return (
        <div className="auth-container">
            <div className="card auth-card" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', alignItems: 'center', width: '100%', maxWidth: '420px' }}>
                ...
                <div className="skeleton-box" style={{ width: '220px', height: '14px' }} />
